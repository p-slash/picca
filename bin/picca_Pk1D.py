    ...
    def process_file(i):
        ...
        for d in dels:
            ...
            for f in range(nb_part):
                ...
                if args.res_estimate == 'Gaussian':
                    ll_new,delta_new,diff_new,iv_new,nb_masked_pixel = fill_masked_pixels(d.dll if not args.linear_lambda else d.dlambda,ll_arr[f],de_arr[f],diff_arr[f],iv_arr[f],args.no_apply_filling,linear_binning=args.linear_binning)
                elif args.res_estimate == 'matrix':
